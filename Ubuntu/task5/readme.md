...
![Screenshot_1](https://user-images.githubusercontent.com/90219892/159230517-7ca10235-e73b-4e7c-b589-a3d1718e49d8.png)
![Screenshot_2](https://user-images.githubusercontent.com/90219892/159230524-e317e6d7-a9ca-4632-9460-43391289f5fa.png)
Первое прохождение 123.12567400932312 s Второе прохождение 135.75910687446594 s Время увеличилось на 12,63с, или на 8,9%, так как мы уведомляем систему что надо записать на диск, и не использовать буфер. В данной работе при создании потоков, для блокировки общих данных от одновременного доступа использовались такие объекты синхронизации, как мютексы( self.mutex = threading.Lock() )
